# Exos\ExosApi\VisitorLogApi

All URIs are relative to /ExosApi/api, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**v10VisitorLogEntriesGet()**](VisitorLogApi.md#v10VisitorLogEntriesGet) | **GET** /v1.0/visitorLogEntries | Get visitor log entries by odata query options |


## `v10VisitorLogEntriesGet()`

```php
v10VisitorLogEntriesGet($expand, $filter, $search_string, $count, $orderby, $select, $skip, $top): \Exos\ExosApi\Model\GetVisitorLogEntriesOutput
```

Get visitor log entries by odata query options
...
$apiInstance = new Exos\ExosApi\Api\VisitorLogApi(
...
try {
    $result = $apiInstance->v10VisitorLogEntriesGet($expand, $filter, $search_string, $count, $orderby, $select, $skip, $top);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VisitorLogApi->v10VisitorLogEntriesGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\Exos\ExosApi\Model\GetVisitorLogEntriesOutput**](../Model/GetVisitorLogEntriesOutput.md)
