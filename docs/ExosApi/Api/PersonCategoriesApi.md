# Exos\ExosApi\PersonCategoriesApi

All URIs are relative to /ExosApi/api, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**v10PersonCategoriesGet()**](PersonCategoriesApi.md#v10PersonCategoriesGet) | **GET** /v1.0/personCategories | get a list of groups by odata query options |


## `v10PersonCategoriesGet()`

```php
v10PersonCategoriesGet($expand, $filter, $search_string, $count, $orderby, $select, $skip, $top): \Exos\ExosApi\Model\CategoriesOutput
```

get a list of groups by odata query options
...
$apiInstance = new Exos\ExosApi\Api\PersonCategoriesApi(
...
try {
    $result = $apiInstance->v10PersonCategoriesGet($expand, $filter, $search_string, $count, $orderby, $select, $skip, $top);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PersonCategoriesApi->v10PersonCategoriesGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\Exos\ExosApi\Model\CategoriesOutput**](../Model/CategoriesOutput.md)
