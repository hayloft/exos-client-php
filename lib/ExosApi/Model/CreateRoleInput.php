...
/**
 * CreateRoleInput Class Doc Comment
 *
 * @category Class
 * @package  Exos\ExosApi
 * @author   OpenAPI Generator team
 ...
 */
class CreateRoleInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateRoleInput';
    ...
    {
        $this->setIfExists('role_name', $data ?? [], 'Role01');
        $this->setIfExists('role_type', $data ?? [], null);
        $this->setIfExists('role_id', $data ?? [], 'Role01');
    }
    ...
    */
     ...
     * Gets role_type
     *
     * @return \Exos\ExosApi\Model\RoleType
     */
     ...
     * Sets role_type
     *
     * @param \Exos\ExosApi\Model\RoleType $role_type role_type
     *
     * @return self
     */
